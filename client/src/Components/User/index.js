        ...
        <div>
            ...
            <form class="login-form">
                <div class="uk-card uk-card-default uk-card-hover uk-card-body">
                    ...
                    <div>
                        <button class="uk-button uk-button-link uk-button-large hover-underline-animation" id="button-login" type="submit">Login</button>
                    </div>
                </div>
            </form>
            ...
            <form class="signup-form">
                <div class="uk-card uk-card-default uk-card-hover uk-card-body">
                    ...
                    <button class="uk-button uk-button-link hover-underline-animation" type="submit" id="signup-btn">Signup</button>
                </div>
            </form>
        </div>
    )
